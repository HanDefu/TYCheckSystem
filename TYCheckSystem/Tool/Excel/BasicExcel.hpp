...
经过测试目前
01.默认是读文件,支持中文文件名
02.写文件需要给WRITE参数,写文件不支持中文文件名
03.写文件以后 save不太好用,要用excel.SaveAs("D:\\excel.xls");
*/
...
public:
	...
	bool Open1(const char* filename, ios_base::openmode mode=ios_base::in | ios_base::out);
...
public: // File functions.
	...
	bool Load(const char* filename, MODE mode =  READ);	///< Load an Excel workbook from a file.
